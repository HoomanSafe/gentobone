  ...
  return (
    <section className="py-[50px] relative w-full bg-red">
      <div className="container flex justify-center items-center text-center flex-col gap-7">
        ...
        <p className="text-xl md:text-2xl mt-10">
          How does it work? Well, imagine stumbling upon a Rare Pepe 2.0 token
          depicting a majestic Pepe in a tutu, gracefully pirouetting atop a
          banana peel. Or perhaps you'll find a limited edition Rare Pepe 2.0
          where Pepe's face is hilariously morphed with that of a rubber
          chicken. The possibilities are as endless as the internet's absurdity!
        </p>
        <img
          src={Pepe}
          alt=""
